    ...
    public function testIndexAddsAllTokensReturnedByTokenizer()
    {
        ...
        $this->clientMock->expects($this->exactly($tokenCount))
            ...
            ->withConsecutive(
                ...
                array($this->equalTo(self::TEST_PREFIX . 'bar'), $this->equalTo(self::TEST_KEY)),
                array($this->equalTo(self::TEST_PREFIX . 'baz'), $this->equalTo(self::TEST_KEY)),
                array($this->equalTo(self::TEST_PREFIX . 'qux'), $this->equalTo(self::TEST_KEY))
            );
